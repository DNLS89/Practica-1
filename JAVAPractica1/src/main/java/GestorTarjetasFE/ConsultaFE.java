 ...
 * @author debian
 */
public class ConsultaFE extends javax.swing.JPanel {
     ...
     */
    public ConsultaFE(SQL sql, GestorArchivoBE gestorArchivoBE) {
        this.sql = sql;
    ...
    private void btnProcesarSolicitudActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarSolicitudActionPerformed
        ...
        if (camposLlenadosCorrectamente()) {
            ConsultaBE consultaBE = new ConsultaBE(sql, txtNumeroTarjeta.getText(), gestorArchivoBE);
